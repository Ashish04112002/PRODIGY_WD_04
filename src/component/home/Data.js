...
const Data =()=>{
    return(
        <div className="home_data">
            <h1 className="home_title">Ashish Kahar
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            Crafting Innovative Solutions: Full Stack Developer Mastering Frontend and Backend 
            Technologies for Seamless Digital Experiences.
